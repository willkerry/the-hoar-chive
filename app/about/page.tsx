    ...
    <>
      ...
      <div className="my-12 prose">
        ...
        <p>
          ...
          &nbsp;and in{' '}
          <a href="http://thetab.com/uk/warwick/2016/02/22/spoke-hoar-satire-free-speech-next-target-13136">
            <em>The Tab</em>
          </a>
          .<br />
          We got{' '}
        ...
        <p>
          After a few seconds of thought we closed the <em>Hoar</em> to focus on
          our drinking.
        </p>
        <p>
        ...
        <Image
          src="/wp-content/uploads/2016/03/protest-footer.png"
          width={608}
          height={166}
